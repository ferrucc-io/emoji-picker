...
export function NpmDownloadsPill({ packageName, defaultDownloads }: NpmDownloadsProps) {
  return (
    <a
    ...
    >
      ...
      {new Intl.NumberFormat('en-US', { notation: 'compact' }).format(defaultDownloads)}/month
    </a>
  );
} 