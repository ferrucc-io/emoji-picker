        ...
        <div className='flex justify-between items-start w-full'>
          <div className="flex flex-col items-start gap-4 text-center">
            ...
            <p className="text-lg text-zinc-600 dark:text-zinc-300 text-left">
              A fast, composable, unstyled emoji picker made <br/> with Tailwind & React
            </p>
          </div>
        ...
        <div className="flex flex-col items-start gap-8 w-full mt-8">
          ...
          <section className="w-full">
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-medium text-zinc-900 dark:text-zinc-50">Basic Example</h3>
              <CodeBlock 
    ...
    <EmojiPicker onEmojiSelect={handleEmojiSelect}>
      ...
      <EmojiPickerGroup>
        <EmojiPickerList />
              ...
              <h3 className="text-lg font-medium mt-8 text-zinc-900 dark:text-zinc-50">With Preview & Skin Tone</h3>
              <CodeBlock 
    ...
    {({ previewedEmoji }) => (
      <>
        ...
        <EmojiPickerSkinTone />
              ...
              <h3 className="text-lg font-medium mt-8 text-zinc-900 dark:text-zinc-50">Customization</h3>
              <CodeBlock 
                code={`<EmojiPicker 
